...
#ifdef BUILD_TAPE_INCOMPATIBLE_NEW_SAVE_STATES
static void sysacia_savestate_BEMSNAP4(FILE *f) {
    acia_savestate_BEMSNAP4(&sysacia, f);
}
static void sysacia_loadstate_BEMSNAP4(FILE *f) {
...
#ifdef BUILD_TAPE_INCOMPATIBLE_NEW_SAVE_STATES
    save_sect(fp, '@', sysacia_savestate_BEMSNAP4); /* BEMSNAP4 */
