...
#include "tape2.h" /* TOHv4: for BUILD_TAPE_INCOMPATIBLE_NEW_SAVE_STATES, BUILD_TAPE_DEV_MENU */
...
int acia_receive_bit_code (ACIA *acia, char code); /* code must be '1', '0', 'L' or 'S' */
