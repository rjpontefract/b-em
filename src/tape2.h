...
/* BUILD OPTIONS */
#define BUILD_TAPE_SANITY                        /* extra run-time checks */
#define BUILD_TAPE_DEV_MENU
#define BUILD_TAPE_MENU_GREYOUT_CAT
#define BUILD_TAPE_INCOMPATIBLE_NEW_SAVE_STATES
#define BUILD_TAPE_NO_FASTTAPE_VIDEO_HACKS       /* remove strange fasttape frameskip thing in video code */
#define BUILD_TAPE_CAT_TIMESTAMPS                /* new-style tape catalogue format containing timestamps */
//#define BUILD_TAPE_CAT_NEED_NEXT_ADDR_ZERO     /* exclude tapecat files w/nonzero "next file addr" (break Citadel) */
#define BUILD_TAPE_TAPECTRL
#define BUILD_TAPE_TAPECTRL_LAMP_OUTLINES
#define BUILD_TAPE_TAPECTRL_ALLOW_RESIZE         /* Allow free resize of tapectrl window. Should be fixed now, so enabled by default. */
// #define BUILD_TAPE_TAPECTRL_DOUBLE_SIZE       /* double-size tape window by default */
// #define BUILD_TAPE_TAPECTRL_PRINT_MUTEX_LOCKS /* for debugging */
// #define BUILD_TAPE_TAPECTRL_LOG_MUTEX_LOCKS   /* for debugging */
#define BUILD_TAPE_TAPECTRL_WIDEN_THIN_STRIPES   /* make thin stripes thicker (to the point where they may now become the New Thick Stripes) */
 /* Do not sleep in tape_ctrl_guithread_main() if no events.
  * This increases responsiveness, but will triple the CPU usage of
  * the tapectrl thread. */
//~ #define BUILD_TAPE_TAPECTRL_DELUXE_RESPONSE
//~ #define BUILD_TAPE_NO_SAVE_FASTTAPE                /* don't copy overclocked tape setting to config file on save */

/* include this line to introduce a bug which produces
   a non-uniform TDRE delay distribution (rather than
   the broadly flat one which actually occurs on hw)
...
#define TAPE_E_UNK_EXT                         13 /* TOHv4.3: no loader exists for this file extension */
/*#define TAPE_E_BLANK_FILENAME                  14*/
#define TAPE_E_BLANK_EXTENSION                 15
...
#define TAPE_E_UEF_SAVE_NONSTD_BAUD           363 /* UEF 0.10 disallows non-300, non-1200 baud rates in chunk 117 (wrongly, IMO) */
#define TAPE_E_UEF_CHUNKDAT_0003              364 /* TOHv4.3 */
...
#define TAPE_E_SAVE_WAV_BODY_TOO_LARGE        404
#define TAPE_E_SAVE_FSEEK                     405

#define TAPE_E_EXPIRY                         500 /* TOHv4 */

/* tapectrl stuff (TOHv4.3) */
#define TAPE_E_DEBUG_BAD_TAPESEEK             600
#define TAPE_E_TAPECTRL_OUTSIDE_ZONE          601 /* not an error */
#define TAPE_E_TAPECTRL_CREATE_THREAD         602 /* al_create_thread() failure */
#define TAPE_E_TAPECTRL_THREAD_EXISTS         603 /* tape_ctrl_start_gui_thread() called but thread already running */
#define TAPE_E_TAPECTRL_THREAD_SHUTTING_DOWN  604 /* al_create_thread() failure */

#define TAPE_E_ACIA_TX_BITCLK_NOT_READY       700 /* not an error */
#define TAPE_E_DEBUG_BAD_TAPEREC              701

/* Unicode */
#define TAPE_E_UNICODE_UNEXPECTED_NULL        800
#define TAPE_E_UNICODE_MAX_LEN                801
#define TAPE_E_ENC_UTF8                       802

/* Allegro */
#define TAPE_E_ALLEGRO_CREATE_BITMAP          900 /* TOHv4.3 */
#define TAPE_E_ALLEGRO_LOCK_BITMAP            901 /* TOHv4.3 */

/* universal fwdrefs */
typedef struct tape_vars_s tape_vars_t;

#define TAPE_TONECODE_IS_LEGAL(c)             (('0'==(c))||('1'==(c))||('S'==(c))||('L'==(c)))
#define TAPE_CRUDE_LEADER_DETECT_1200THS      170
