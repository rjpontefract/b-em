...
#define TAPE_E_UNICODE_UNEXPECTED_NULL        370
#define TAPE_E_UNICODE_MAX_LEN                371
#define TAPE_E_ENC_UTF8                       372
...
#define TAPE_E_ACIA_TX_BITCLK_NOT_READY       600 /* not an error */
