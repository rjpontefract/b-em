...
// #define BUILD_TAPE_TAPECTRL_ALLOW_RESIZE         /* allow free resize. Broken on macOS, so disabled by default */
...
/*
#define TAPE_EOF_TRISTATE_NO        2
#define TAPE_EOF_TRISTATE_YES       3
#define TAPE_EOF_TRISTATE_UNCHANGED 4
*/
