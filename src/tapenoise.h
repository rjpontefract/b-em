...
#define TAPENOISE_VOLUME_DEFAULT 0.20
#define TAPENOISE_VOLUME_MINIMUM 0.02
...
void tapenoise_set_activated (tape_ctrl_window_t * const tcw, bool const activated, bool const alter_menu);
...
void tapenoise_set_volume (tape_ctrl_window_t * const tcw,
                           float const fraction,
                           bool const alter_menu); /* TOHv4.4 */
