...
typedef struct tibet_span_s {
  ...
  tape_interval_t timespan; /* TOHv4.3 */
...
int tibet_read_bit (tibet_t *t,
                    ...
                    int32_t *elapsed_1200ths_or_minus_one_or_null_out); /* TOHv4.4 */
...
/* TOHv4.3 */
int tibet_seek (tibet_t *t, uint8_t wanted_1200ths, int32_t *got_1200ths_out);
int tibet_get_duration (tibet_t *t, int32_t *out_1200ths);
int tibet_get_num_spans (tibet_t *t, uint32_t *out);
int tibet_get_time_interval_for_span (tibet_t *t, uint32_t span_ix, tape_interval_t *interval_out);
int tibet_get_type_for_span (tibet_t * const t, uint32_t const span_ix, char * const type_out) ; /* -a4 */
