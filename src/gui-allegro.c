...
static ALLEGRO_MENU *create_tape_menu(void)
{
    ...
    /* // feature postponed
    fflags = 0;
    al_append_menu_item(menu, "Examine chunks", IDM_TAPE_EXAMINE, fflags, NULL, NULL);
    */
...
void gui_allegro_event(ALLEGRO_EVENT *event)
{
    switch(menu_get_id(event)) {
        ...
        case IDM_TAPE_REWIND:
            tape_rewind_2(&tape_state); /* now lives on tape.c */
            break;
        case IDM_TAPE_EJECT:
            tape_eject();
            break;
        ...
        case IDM_TAPE_CAT:
            ...
            break;
        /* // feature postponed
        case IDM_TAPE_EXAMINE:
            gui_tape_examine_start(&tape_vars, &tape_state);
            break;
        */
