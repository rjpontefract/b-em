...
#define TAPE_TONES300_BUF_LEN 4
    ...
    /* TOHv4.2:
       Don't engage "strip mode" until half a second of tape
...
typedef struct tape_vars_s {
    ...
    uint8_t wav_use_phase_shift; /* TOHv4.2 */
    
    /* TOHv4.2: */
    /*tape_examine_t examine; */
...
int tape_rewind_2 (tape_state_t *ser);
...
/* TOHv4.2: exported, for use by tapenoise_write_wav() in tapenoise.c */
int tape_tone_1200th_from_back_end (uint8_t strip_silence_and_leader, /* speedup */
                                    tape_state_t *ts,
